...
// Source: github.com/todevmilen/simplebank/db/sqlc (interfaces: Store)
//
// Generated by this command:
//
//	mockgen -package mockdb -destination db/mock/store.go github.com/todevmilen/simplebank/db/sqlc Store
//
